...
var BrMaskerDirective = (function () {
    function BrMaskerDirective(_renderer, _elementRef) {
        this._renderer = _renderer;
        this._elementRef = _elementRef;
        this.brmasker = new BrMaskModel();
    }
    BrMaskerDirective.prototype.inputKeyup = function (event) {
        var value = this.returnValue(event.target.value);
        this.writeValue(value);
        event.target.value = value;
    };
    BrMaskerDirective.prototype.inputOnblur = function (event) {
        var value = this.returnValue(event.value);
        this.writeValue(value);
        event.value = value;
    };
    BrMaskerDirective.prototype.inputFocus = function (event) {
        var value = this.returnValue(event.value);
        this.writeValue(value);
        event.value = value;
    };
    ...
    BrMaskerDirective.prototype.writeValue = function (fn) {
        this._renderer.setElementProperty(this._elementRef.nativeElement, 'value', fn);
    };
    BrMaskerDirective.prototype.registerOnChange = function (fn) {
        return;
    };
    BrMaskerDirective.prototype.registerOnTouched = function (fn) {
        return;
    };
    BrMaskerDirective.prototype.setDisabledState = function (isDisabled) {
        if (isDisabled) {
    ...
    BrMaskerDirective.prototype.writeCreateValue = function (value, config) {
    ...
    BrMaskerDirective.prototype.writeValuePercent = function (value) {
        value.replace(/\D/gi, '');
        value.replace(/%/gi, '');
        return value.replace(/([0-9]{0})$/gi, '%$1');
    };
    BrMaskerDirective.prototype.writeValuePerson = function (value) {
        if (value.length <= 11) {
    ...
    BrMaskerDirective.prototype.writeValueMoney = function (value, config) {
        if (config === void 0) { config = new BrMaskModel(); }
        value.replace(/\D/gi, '');
    ...
    BrMaskerDirective.prototype.returnValue = function (value) {
    ...
    BrMaskerDirective.prototype.percentMask = function (v) {
        var tmp = v;
    ...
    BrMaskerDirective.prototype.phoneMask = function (v) {
        var n = v;
        if (n.length > 14) {
    ...
    BrMaskerDirective.prototype.peapollMask = function (v) {
        var n = v;
        n = n.replace(/\D/gi, '');
        if (n.length >= 14) {
    ...
    BrMaskerDirective.prototype.moneyMask = function (v) {
        var tmp = v;
        tmp = tmp.replace(/\D/gi, '');
    ...
    BrMaskerDirective.prototype.formatField = function (campo, Mascara, tamanho) {
        if (!tamanho) {
            tamanho = 99999999999;
        }
        var boleanoMascara;
...
BrMaskerDirective.ɵfac = function BrMaskerDirective_Factory(t) { return new (t || BrMaskerDirective)(ɵngcc0.ɵɵdirectiveInject(Renderer), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef)); };
BrMaskerDirective.ɵdir = /*@__PURE__*/ ɵngcc0.ɵɵdefineDirective({ type: BrMaskerDirective, selectors: [["", "brmasker", ""]], hostBindings: function BrMaskerDirective_HostBindings(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵlistener("keyup", function BrMaskerDirective_keyup_HostBindingHandler($event) { return ctx.inputKeyup($event); })("ionBlur", function BrMaskerDirective_ionBlur_HostBindingHandler($event) { return ctx.inputOnblur($event); })("ionFocus", function BrMaskerDirective_ionFocus_HostBindingHandler($event) { return ctx.inputFocus($event); });
    } }, inputs: { brmasker: "brmasker" }, features: [ɵngcc0.ɵɵProvidersFeature([{
                provide: NG_VALUE_ACCESSOR,
                useExisting: BrMaskerDirective,
                multi: true
            }])] });
BrMaskerDirective.ɵprov = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjectable({ token: BrMaskerDirective, factory: function (t) { return BrMaskerDirective.ɵfac(t); } });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(BrMaskerDirective, [{
        type: Directive,
        args: [{
                selector: '[brmasker]',
                providers: [{
        ...
        type: Injectable
    }], function () { return [{ type: Renderer }, { type: ɵngcc0.ElementRef }]; }, { brmasker: [{
            type: Input
        }], inputKeyup: [{
            type: HostListener,
            args: ['keyup', ['$event']]
